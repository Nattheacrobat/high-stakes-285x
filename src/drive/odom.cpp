...
void Odom::set_position(Point pos, float orientation_deg, float ForwardTracker_position, float SidewaysTracker_position){
...
void Odom::update_position(float ForwardTracker_position, float SidewaysTracker_position, float orientation_deg){
  ...
  pos.x += X_position_delta;
  pos.y += Y_position_delta;
}